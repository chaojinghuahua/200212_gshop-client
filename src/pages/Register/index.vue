<template>
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="content">
        <label>手机号:</label>
        <!-- regex: /^1\d{10}$/}正则必须以1开头，接着跟上10个数字 ，必须要有name-->
        <!-- errors属性里面有没有phone的错误存在，如果有就是真，没有就假 -->
        <!-- 取出phone所对应的错误功能 -->
...
<script type="text/ecmascript-6">
  export default {
    ...
    methods: {
      /*
      更新验证码图片 ===> 浏览器再发一次请求获取新的图片
      */
      updateCode(){
        // 重新指定img的src(如果在移动端需要携带一个时间戳的参数)
        this.$refs.code.src = '/api/user/passport/code'
        // this.$refs.code.src = '/api/user/passport/code?time=' + Data.now()
      },
